...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
        ...
        if (WEB3FORMS_ACCESS_KEY) {
            ...
            setResult("Configuration Error: Key missing.");
            return;
        }
    ...
    return (
        ...
        >
            ...
            {/* 👇 Added quick contact links */}
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-10">
                <a 
                    href="mailto:rajguptavips2025@gmail.com" 
                    className="flex items-center gap-2 px-6 py-2 border rounded-full bg-white shadow-sm hover:bg-gray-100 dark:bg-darkHover/30 dark:border-white/50"
                >
                    <Image src={assets.mail_icon} alt="mail" className="w-5" />
                    rajguptavips2025@gmail.com
                </a>
                <a 
                    ...
                    className="flex items-center gap-2 px-6 py-2 border rounded-full bg-white shadow-sm hover:bg-gray-100 dark:bg-darkHover/30 dark:border-white/50"
                >
                    <Image src={assets.linkedin_icon || assets.web_icon} alt="linkedin" className="w-5" />
                    LinkedIn
                </a>
            </div>
            ...
            onSubmit={onSubmit} className='max-w-2xl mx-auto'>
                ...
                <p className='mt-4 text-center text-lg font-medium'>{result}</p>
            </motion.form>
        </motion.div>
    )
}
